...
//	( Breath under water, swim fast, and have a natural affinity for the sea. )
//	( +1 Swimming and TRAIT_WATERBREATHING )
...
/datum/species/axian
	name = "Axian"
	id = "axian"
	desc = "Axians, the heirs of true land. \
	\n\n\
	...
	\n\n\
	Axians are the apex predators of the seas with true domain of both swimming \
	and breathing while submerged..."

// Nothing was changed below this line, this is a template for future species.
...
/datum/species/axian/get_hairc_list()
	return sortList(list(
	"blond - pale" = "9d8d6e",
	"blond - dirty" = "88754f",
...
/datum/species/axian/get_possible_surnames(gender = MALE)
