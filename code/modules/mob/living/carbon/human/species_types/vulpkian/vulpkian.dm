...
/mob/living/carbon/human/species/vulpkian
	race = /datum/species/vulpkian
...
/datum/species/vulpkian/check_roundstart_eligible()
	return TRUE

/datum/species/vulpkian/get_skin_list()
...
/datum/species/vulpkian/get_hairc_list()
	return sortList(list(
	"blond - pale" = "9d8d6e",
	"blond - dirty" = "88754f",
...
/datum/species/vulpkian/get_possible_names(gender = MALE)
...
/datum/species/vulpkian/get_possible_surnames(gender = MALE)
