...
/datum/species/lizardfolk
	...
	\n\n\
	Suffering and enslavement came with a great cost, but such effort returned a great blessing \
	their body resist poison greatly..."


// Template, for the lizardfolk species - subject to change
...
/datum/species/lizardfolk/get_hairc_list()
	return sortList(list(
	"blond - pale" = "9d8d6e",
	"blond - dirty" = "88754f",
...
/datum/species/lizardfolk/get_possible_names(gender = MALE)
...
/datum/species/lizardfolk/get_possible_surnames(gender = MALE)
