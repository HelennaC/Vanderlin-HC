...
/datum/species/moth
	name = "Fluvian"
	id = "moth"
	desc = "Seekers, the finders of the true light. \
	\n\n\
	...
	\n\n\
	Fluvians  tend to find fortune easier than the other species, and are so diverse that no other trait \
	are dominant in their species..."

// Template moth, bzzzzzz LAMP!
	...
	limbs_icon_f = 'icons/roguetown/mob/bodies/f/fmoth.dmi'
...
/datum/species/moth/get_hairc_list()
	return sortList(list(
	"blond - pale" = "9d8d6e",
	"blond - dirty" = "88754f",
...
/datum/species/moth/get_possible_names(gender = MALE)
...
/datum/species/moth/get_possible_surnames(gender = MALE)
