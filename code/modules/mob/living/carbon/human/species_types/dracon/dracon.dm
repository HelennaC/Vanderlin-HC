...
/datum/species/dracon
	name = "Drakian"
	id = "dracon"
	desc = "Drakians, the first to gain nobility. \
	\n\n\
	...
	\n\n\
	When all was chaos and lack of any ruler, one came to claim the empty throne \
	no creature has seen the stars as close as them..."

// Below this line is a copy of the human species, template to be changed later.
...
/datum/species/dracon/get_hairc_list()
	return sortList(list(
	"blond - pale" = "9d8d6e",
	"blond - dirty" = "88754f",
...
/datum/species/dracon/get_possible_names(gender = MALE)
...
/datum/species/dracon/get_possible_surnames(gender = MALE)
